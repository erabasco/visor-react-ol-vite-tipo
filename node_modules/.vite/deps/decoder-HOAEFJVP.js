...
function create() {
  ...
  return new import_web_worker.default(typeof Blob === "undefined" ? "data:application/javascript;base64," + Buffer.from(source, "binary").toString("base64") : URL.createObjectURL(new Blob([source], { type: "application/javascript" })));
}
export {
  create
};
//# sourceMappingURL=decoder-HOAEFJVP.js.map
