      ...
      for (let reproj = reprojs - 1; reproj >= 0; --reproj) {
        ...
        for (let i = 0, len = dataSources.length; i < len; ++i) {
          ...
          for (let j = 0, len2 = data2.length; j < len2; j += 4) {
            data2[j] = buffer4[offset2];
            data2[j + 1] = buffer4[offset2 + 1];
            data2[j + 2] = buffer4[offset2 + 2];
            data2[j + 3] = 255;
...
function roundToFloat16Bits(num) {
  const absNum = MathAbs(
    /** @type {number} */
    num
  );
  const s = (
    /** @type {number} */
    num < 0 || ObjectIs(num, -0) ? 1 : 0
  );
  let m, e;
  if (!NumberIsFinite(absNum)) {
    m = NumberIsNaN(absNum) ? 512 : 0;
    e = f16EMax;
  } else {
    ...
    if (rawE + f16EBias >= f16EMax) {
      ...
      m = roundTiesToEven((absNum * c - 1) * 1024) & f16MMask;
      e = rawE + f16EBias;
    } else {
      m = roundTiesToEven(absNum * 16777216) & f16MMask;
      e = 0;
    }
  }
...
addDecoder([void 0, 1], () => import("./raw-NSNIY53G.js").then((m) => m.default));
addDecoder(5, () => import("./lzw-OS7PFP7E.js").then((m) => m.default));
addDecoder(6, () => {
  throw new Error("old style JPEG compression is not supported.");
});
addDecoder(7, () => import("./jpeg-ZDCCPP7J.js").then((m) => m.default));
addDecoder([8, 32946], () => import("./deflate-HFXIXWBT.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-CNOU7KE2.js").then((m) => m.default));
addDecoder(34887, () => import("./lerc-FWICPLN4.js").then((m) => m.default));
addDecoder(50001, () => import("./webimage-2PLUH2HG.js").then((m) => m.default));
  ...
  constructor(size = defaultPoolSize, createWorker2) {
    ...
    if (size) {
      this._awaitingDecoder = createWorker2 ? Promise.resolve(createWorker2) : new Promise((resolve) => {
        import("./decoder-HOAEFJVP.js").then((module) => {
...
var CanvasImageLayerRenderer = class extends Layer_default2 {
  ...
  renderFrame(frameState, target) {
    ...
    const viewResolution = viewState.resolution;
    const scale3 = pixelRatio * imageResolution / (viewResolution * imagePixelRatio);
...
var Processor = class extends Disposable_default {
  ...
  _resolveJob() {
    ...
    if (threads === 1) {
      ...
      const segmentLength = 4 * Math.ceil(length / 4 / threads);
      for (let i = 0; i < threads; ++i) {
        const buffer4 = this._dataLookup[i]["buffer"];
        const offset = i * segmentLength;
...
var WMTS = class extends TileImage_default {
  ...
  createFromWMTSTemplate(template) {
    ...
    template = requestEncoding == "KVP" ? appendParams(template, context2) : template.replace(/\{(\w+?)\}/g, function(m, p) {
